...
import { AuditOutlined, TagsOutlined, TeamOutlined, UploadOutlined } from "@ant-design/icons";
...
// 后台设置：把人员权限、标签配置、数据导入、操作日志等低频管理功能收进一个管理员专属页面，
  ...
  return (
    <Tabs
      ...
      items={[
        ...
        { key: "dicts", label: <span><TagsOutlined /> {t("标签配置")}</span>, children: <DictAdmin /> },
